...
export const metadata: Metadata = {
	...
	title: 'Educa praktikum | Online kurslari',
	description:
		"Educa praktikum | Online kurslari, amaliyotlar, startup loyihalar va asosiysi sifatli ta'limdir.",
	authors: [{ name: 'Samar Badriddinov', url: 'https://startup.sammi.ac' }],
	icons: { icon: '/logo.svg' },
	openGraph: {
		title: 'Educa | Online kurslari',
		description:
			"Educa | Online kurslari, amaliyotlar, startup loyihalar va asosiysi sifatli ta'limdir.",
		type: 'website',
